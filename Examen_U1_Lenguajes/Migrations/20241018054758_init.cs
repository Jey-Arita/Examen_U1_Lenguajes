    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_permiso = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    tipo_permiso = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nombre_empleado = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    password = table.Column<string>(type: "nvarchar(320)", maxLength: 320, nullable: false),
                    id_cargo = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tipo_permiso = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
